...
function createHashTags(arr) {
    return arr.reduce(function(accum,element){
        accum[element._id] = element.company;
        return accum; 
    },{})
}
...
let arrayForImplement = [1,1,1,4,4,3,3,3,3,2,5,5,5,6,7,4,4,4,10,10,23,20,23,23,11,123,123,123,15];

function reduceImplement(array, callback, accum) {
    var accum = accum;
